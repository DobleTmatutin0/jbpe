...
public class DetalleEspecieDTO {
    private Long id;

    @NotNull(message = "El nombre de el detalleEspecie es obligatorio")
    @NotBlank(message = "El nombre de el detalleEspecie no puede estar en blanco")
